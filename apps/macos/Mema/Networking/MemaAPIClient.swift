...
protocol MemaAPIClient: Sendable {
...
struct LiveMemaAPIClient: MemaAPIClient, Sendable {
    let baseURL: URL
    ...
    func createImageCapture(_ request: ImageCaptureUploadRequest) async throws -> Capture {
        let boundary = "MemaBoundary-\(UUID().uuidString)"
    ...
    func attachmentData(contentPath: String) async throws -> Data {
        ...
        guard components.count == 4,
            ...
            throw MemaAPIError.invalidResponse
        }
    ...
    private func send<Response: Decodable>(
        ...
        do {
            ...
            throw MemaAPIError.decoding(error.localizedDescription)
        }
    }
