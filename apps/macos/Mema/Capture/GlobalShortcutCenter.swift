...
private let memaGlobalHotKeySignature: OSType = 0x4D454D41 // "MEMA"
    ...
    init(
        ...
        if let storedData = userDefaults.data(forKey: Self.userDefaultsKey) {
            do {
                ...
                initialMessage = "Saved shortcuts were invalid, so Mema restored its defaults."
        ...
        do {
            ...
            do {
                ...
                errorMessage = "Mema kept your existing shortcuts active, but the new "
    ...
    func apply(_ proposedConfiguration: GlobalShortcutConfiguration) -> Bool {
        ...
        do {
            ...
            do {
                ...
                registrations = [:]
                activeActions = []
                errorMessage = "\(applyError) Mema also could not restore the previous "
...
private enum CarbonGlobalShortcutError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .shortcutInUse:
            return "That shortcut is already in use by Mema or another app."
...
final class CarbonGlobalShortcutRegistrar: GlobalShortcutRegistering {
    ...
    func register(
        ...
        let hotKeyID = EventHotKeyID(
            signature: memaGlobalHotKeySignature,
            id: identifier
        )
...
private func memaGlobalHotKeyEventHandler(
    ...
    guard hotKeyID.signature == memaGlobalHotKeySignature else {
