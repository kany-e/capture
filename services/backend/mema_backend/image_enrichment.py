...
from mema_backend.attachments import AttachmentStorage, AttachmentStorageError
from mema_backend.embeddings import EmbeddingProvider, build_embedding_input
...
from mema_backend.limits import SELECTED_TEXT_MAX_LENGTH
from mema_backend.models import CaptureRecord, EnrichmentUpdate
from mema_backend.repository import CaptureNotFoundError, CaptureRepository


logger = logging.getLogger(__name__)
IMAGE_ENRICHMENT_SCHEMA_RESOURCE = files("mema_backend").joinpath(
